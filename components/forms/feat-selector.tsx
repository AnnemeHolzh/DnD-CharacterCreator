...
import { feats, getAvailableFeats, getEligibleFeats, meetsFeatPrerequisites } from "@/lib/data/feats"
...
export function FeatSelector() {
  ...
  // Calculate remaining feats
  const remainingFeats = availableFeats - selectedFeats.length
      ...
      <div className="flex items-center justify-between p-4 bg-amber-900/20 border border-amber-800/30 rounded-lg">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-blue-300">Remaining Feats</div>
          </div>
        </div>
